...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText1 = wx.StaticText( self, wx.ID_ANY, u"Enter a Number", wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		...
		# Connect Events
		self.m_button1.Bind( wx.EVT_BUTTON, self.FindSqure() )
